...
final class ThemeStore: ObservableObject {
    ...
    private var xcodeLightTokens: ThemeTokens {
        ThemeTokens(
            ...
            elevatedSurface: Color(red: 0.90, green: 0.94, blue: 0.98),
            userBubble: Color(red: 0.00, green: 0.44, blue: 0.86).opacity(0.16),
            assistantBubble: Color(red: 0.99, green: 1.00, blue: 1.00),
            systemBubble: Color(red: 0.88, green: 0.93, blue: 0.98),
            codeBlock: Color(red: 0.10, green: 0.15, blue: 0.22),
            codeText: Color(red: 0.91, green: 0.96, blue: 1.00),
            primaryText: Color(red: 0.07, green: 0.11, blue: 0.17),
            secondaryText: Color(red: 0.32, green: 0.39, blue: 0.48),
            tertiaryText: Color(red: 0.48, green: 0.56, blue: 0.64),
            accent: Color(red: 0.00, green: 0.44, blue: 0.86),
            warning: Color(red: 0.86, green: 0.43, blue: 0.06),
            success: Color(red: 0.00, green: 0.52, blue: 0.30),
            border: Color(red: 0.72, green: 0.80, blue: 0.88),
            selectionFill: Color(red: 0.00, green: 0.44, blue: 0.86).opacity(0.14)
        )
    }
    ...
    private var xcodeDarkTokens: ThemeTokens {
        ThemeTokens(
            ...
            surface: Color(red: 0.09, green: 0.12, blue: 0.17),
            elevatedSurface: Color(red: 0.14, green: 0.18, blue: 0.25),
            userBubble: Color(red: 0.20, green: 0.56, blue: 1.00).opacity(0.34),
            assistantBubble: Color(red: 0.10, green: 0.13, blue: 0.18),
            systemBubble: Color(red: 0.16, green: 0.20, blue: 0.27),
            codeBlock: Color(red: 0.02, green: 0.05, blue: 0.09),
            codeText: Color(red: 0.88, green: 0.94, blue: 1.00),
            primaryText: Color(red: 0.92, green: 0.95, blue: 0.98),
            secondaryText: Color(red: 0.68, green: 0.74, blue: 0.82),
            tertiaryText: Color(red: 0.50, green: 0.58, blue: 0.67),
            accent: Color(red: 0.36, green: 0.68, blue: 1.00),
            warning: Color(red: 1.00, green: 0.66, blue: 0.24),
            success: Color(red: 0.32, green: 0.78, blue: 0.52),
            border: Color(red: 0.24, green: 0.32, blue: 0.42),
            selectionFill: Color(red: 0.36, green: 0.68, blue: 1.00).opacity(0.18)
        )
    }
