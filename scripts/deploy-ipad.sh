...
DEVICE_ID="${DEVICE_ID:-}"
BUNDLE_ID="${BUNDLE_ID:-com.gaixiaotongxue.CodexAgentPad}"
...
IOS_DEVELOPMENT_TEAM="${IOS_DEVELOPMENT_TEAM:-${DEVELOPMENT_TEAM:-9HZ89R58PZ}}"
...
APP_PATH="$DERIVED_DATA_PATH/Build/Products/$CONFIGURATION-iphoneos/CodexAgentPad.app"
